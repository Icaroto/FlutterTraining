...
//           //dex[index].ref.split("|").some(item => item.includes(".0"))
//           // if(dex[index].ref == "" || dex[index].ref.includes(".0")) { //means ALL forms are included
//           if(dex[index].ref == "") {
...
//             var toAdd = 
//               [
//                 {"name":"Pokemon Scarlet","dex":"Blueberry","number": num, "shinyLocked": lock, "notes": sNotes},
//                 {"name":"Pokemon Violet","dex":"Blueberry","number": num, "shinyLocked": lock, "notes": vNotes}
//               ]
